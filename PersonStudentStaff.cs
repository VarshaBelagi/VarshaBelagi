using System;using System.Collections.Generic;using System.Linq;using System.Text;using System.Threading.Tasks;namespace Assignments{    class PersonStudentStaff    {        static void Main(string[] args)        {

            Person[] people = {                                new Person("harsha", "Mysore", "Karnataka", " fundamentals", 2010, 4500.0),                                new Person("sparsha", "Bangalore"," Karnataka", "Delhi Public school", 35000.0),                                new Person("vardhan", "Manalore", "Karnataka", "National Public school", 42000.0),                                new Person("Seetha", "Hospet", "Karnataka", " fundamentals", 2012, 4750.0),                                new Person("Kiran", "Bellary", "Goa", "Reactjs", 2017, 12500.0)                                };            Console.ReadLine();        }    }
